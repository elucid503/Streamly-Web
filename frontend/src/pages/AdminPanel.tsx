      ...
      <Modal open={open} onClose={onClose} title="Access Codes" className="max-w-lg">
        <div className="mb-6 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="mb-1 block text-xs text-foreground-muted">Max Uses (0 = unlimited)</label>
            ...
            {codes.map((code) => (
              ...
              >
                ...
                <div className="flex gap-1">
                  <button
                    onClick={() => this.copy(code.code)}
                    className="rounded-md p-1.5 text-foreground-muted hover:bg-surface-overlay hover:text-foreground"
                  >
                    <Copy size={13} />
                  </button>
                  <button
                    onClick={() => this.remove(code.code)}
                    className="rounded-md p-1.5 text-foreground-muted hover:bg-surface-overlay hover:text-red-400"
                  >
                    <Trash2 size={13} />
                  </button>
                </div>
