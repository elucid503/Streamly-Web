...
import { LiveLogo } from "@/Features/Live/LiveLogo";

import { liveAPI } from "@/Features/Live/Api";
import type { ChannelGuideEntry, LiveChannel, ProgramEntry } from "@/Features/Live/Types";
...
export class TVGuide extends Component<TVGuideProps, TVGuideState> {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      const raw = await liveAPI.schedule() ?? [];
