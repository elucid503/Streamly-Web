    ...
    return (
      ...
      >
        ...
        <div
          className={
            hovering
              ? "w-[104px] overflow-hidden opacity-100 transition-all duration-200 ease-out"
              : "w-0 overflow-hidden opacity-0 transition-all duration-200 ease-out"
          }
        >
          <div className="relative mx-2 flex h-7 w-24 items-center">
            ...
            <input
              ...
              className="player-range relative z-10 h-7 w-full cursor-pointer appearance-none bg-transparent"
              aria-label="Volume"
            />
          </div>
        </div>
