...
func NewCatalogHandler(media *MediaService) *CatalogHandler {
...
func (h *CatalogHandler) Search(c *gin.Context) {
	...
	if query == "" {
		...
		httpx.WriteError(c, http.StatusBadRequest, "query required")
		return
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(results))
...
func (h *CatalogHandler) MovieTrending(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(items))
...
func (h *CatalogHandler) MovieCategories(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(cats))
...
func (h *CatalogHandler) MovieCategoryTitles(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(titles))
...
func (h *CatalogHandler) ShowSeasons(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(seasons))
...
func (h *CatalogHandler) SeasonEpisodes(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(episodes))
...
func (h *CatalogHandler) LiveChannels(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(channels))
...
func (h *CatalogHandler) LiveSports(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(events))
...
func (h *CatalogHandler) LiveSchedule(c *gin.Context) {
	...
	c.JSON(http.StatusOK, httpx.JSONSlice(entries))
