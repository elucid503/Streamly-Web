...
type Fallback interface {
	...
	CatalogTrendingHits(kind mediakit.MediaKind, limit int) []catalogindex.SearchResultDTO
	CatalogIndex() []catalogindex.SearchResultDTO
	SearchTitles(query string) []catalogindex.SearchResultDTO
...
func (s *Service) Feed(kind string) HomeFeed {
